...
/** 交互参数类型 */
export type InteractionParamType = 'none' | 'appoint' | 'dismiss' | 'centralization' | 'declareWar' | 'transferVassal' | 'revoke' | 'joinWar' | 'callToArms' | 'usurpPost' | 'reassign' | 'demandRights' | 'negotiateTax';
