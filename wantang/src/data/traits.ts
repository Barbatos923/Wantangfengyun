...
const personalityTraits: TraitDef[] = [
  ...
  },
  {
    ...
    name: '知足',
    category: 'personality',
    description: '安守本分，不慕荣华。对上级好感+10',
    abilityModifiers: {},
  ...
  },
  {
    ...
    name: '专断',
    category: 'personality',
    description: '任性独断，不拘法度。谋略+3 管理-2',
  ...
  // ── 5. 多疑 vs 仁信 (Paranoid / Trusting) ────────
  {
    ...
    name: '多疑',
    category: 'personality',
    description: '猜忌多疑，事必躬亲。谋略+3 对所有人好感-10',
  ...
  },
  {
    ...
    name: '仁信',
    category: 'personality',
    description: '推心置腹，用人不疑。外交+2 对所有人好感+10',
  ...
  // ── 6. 沉稳 vs 暴躁 (Calm / Wrathful) ────────────
  {
    ...
    name: '沉稳',
    category: 'personality',
    description: '泰山崩于前而色不变。外交+1 谋略+1',
  ...
  },
  {
    ...
    name: '嗜杀',
    category: 'personality',
    description: '暴虐嗜杀，以杀止杀。军事+2 谋略+2 每月民心-1',
    abilityModifiers: { military: 2, strategy: 2 },
