...
Phase 5  AI 史书            ░░░░░░░░░░░░    0%  ⬜ 未开始
Phase 6  谋略 + 派系 + 事件 ██████░░░░░░    50%  ⬜ 已完成核心的NPC Engine，继续填充其他NPC及玩家行为
...
| 时间控制 | ✅ | 中文日期显示（年月日）+ 速度控制（暂停/正常/快速/极速）+ 下一日/下月按钮 + 自动推进 |
...
**待做：**
- NPC Engine 日结化（按品级哈希打散行为到不同天，设计中）
