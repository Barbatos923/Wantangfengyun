...
| 文档 | 说明 |
|------|------|
| [GDD-v2.0.md](GDD-v2.0.md) | **当前权威设计案**。官职/经济/领地/数据模型以此为准；角色/军事/谋略/派系/继承/史书章节参阅 v1.0 |
| [milestones.md](milestones.md) | **开发里程碑**（反映实际进度） |
...
| 文档 | 说明 |
|------|------|
| [CK3-性格特质表.md](reference/CK3-性格特质表.md) | CK3 完整性格特质效果表，设计参考 |
| [CK3-战略分析prompt.md](reference/CK3-战略分析prompt.md) | CK3 战略分析 prompt |
| [CK3-史书撰写.txt](reference/CK3-史书撰写.txt) | 史书撰写 prompt |
